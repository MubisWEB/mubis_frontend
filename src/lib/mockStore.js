...
// ── Seed data ──
const SEED_USERS = [
  { id: 'u-admin-1', email: 'admin@mubis.com', password: 'admin123', role: 'admin', nombre: 'Admin Mubis', company: 'Mubis', branch: 'Principal', telefono: '3000000000', ciudad: 'Bogotá', nit: '' },
  { id: 'u-dealer-1', email: 'dealer@test.com', password: 'dealer123', role: 'dealer', nombre: 'Autonal Colombia', company: 'Autonal', branch: 'Bogotá Norte', telefono: '3001112233', ciudad: 'Bogotá', nit: '900123456-7' },
  { id: 'u-dealer-2', email: 'dealer2@test.com', password: 'dealer123', role: 'dealer', nombre: 'Los Coches', company: 'Los Coches', branch: 'Medellín Centro', telefono: '3159998877', ciudad: 'Medellín', nit: '900234567-8' },
  { id: 'u-perito-1', email: 'perito@test.com', password: 'perito123', role: 'perito', nombre: 'Carlos Peritaje', company: 'Autonal', branch: 'Bogotá Norte', telefono: '3201234567', ciudad: 'Bogotá', nit: '' },
  { id: 'u-perito-2', email: 'perito2@test.com', password: 'perito123', role: 'perito', nombre: 'María Inspección', company: 'Los Coches', branch: 'Medellín Centro', telefono: '3107654321', ciudad: 'Medellín', nit: '' },
  { id: 'u-recomprador-1', email: 'recomprador@test.com', password: 'recomprador123', role: 'recomprador', nombre: 'CarMax Colombia', company: 'CarMax', branch: 'Cali Sur', telefono: '3114567890', ciudad: 'Cali', nit: '900345678-9' },
];
...
export function registerUser(userData) {
  ...
  const user = { id: `u-${Date.now()}`, ...userData, createdAt: new Date().toISOString(), status: 'pending' };
  users.push(user);
...
export function loginUser(email, password) {
  ...
  if (ADMIN_EMAILS.includes(email)) {
    ...
    if (password === 'admin123') {
      return { id: 'u-admin-1', email, role: 'admin', nombre: 'Admin Mubis', company: 'Mubis', branch: 'Principal' };
    }
    return null;
  }
...
export function logoutUser() {
  ['mubis_authenticated', 'mubis_user_role', 'mubis_user_email', 'mubis_user_id',
   'mubis_user_company', 'mubis_user_branch', 'mubis_user_name'].forEach(k => localStorage.removeItem(k));
}
