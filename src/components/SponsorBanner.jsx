  ...
  <div className="w-full h-full bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 flex items-center justify-between px-6 sm:px-10 lg:px-16">
    ...
    <div className="hidden sm:flex items-center gap-4">
      <div className="flex gap-2">
        {['4', 'días'].map((text, i) => (
          <div key={i} className="w-14 h-14 lg:w-18 lg:h-18 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center">
...
const Banner4 = () => (
  <div className="w-full h-full bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 flex items-center justify-between px-6 sm:px-10 lg:px-16">
    ...
    <div className="absolute bottom-0 right-0 w-48 h-full opacity-5">
      <svg viewBox="0 0 200 100" className="w-full h-full"><circle cx="100" cy="100" r="90" fill="white"/></svg>
    </div>
  </div>
);
