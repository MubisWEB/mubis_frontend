...
export default function Header({ title, subtitle, backTo, onBack, children }) {
  ...
  return (
    <>
      ...
      {(title || subtitle || backTo || onBack) && (
        <div className="px-4 sm:px-6 lg:px-8 pt-5 pb-2 flex items-center gap-3">
          {(backTo || onBack) && (
            <button onClick={handleBackClick} className="w-9 h-9 rounded-full bg-muted flex items-center justify-center flex-shrink-0">
