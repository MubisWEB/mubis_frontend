        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {["Cómo funciona", "Testimonios", "Valuación gratis", "Para concesionarios"].map((l) => (
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2"><Mail className="w-4 h-4 text-secondary" /> contacto@mubis.com</li>
              <li className="flex items-center gap-2"><Phone className="w-4 h-4 text-secondary" /> +52 55 1234 5678</li>
              <li className="flex items-center gap-2"><MapPin className="w-4 h-4 text-secondary" /> Ciudad de México, México</li>
            </ul>
          </div>
        </div>
      </div>
