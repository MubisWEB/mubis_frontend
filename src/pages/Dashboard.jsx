...
const demoData = {
  ...
  tendenciaVentas: [
    { mes: 'Jul', ventas: 18, ingresos: 1580 },
    { mes: 'Ago', ventas: 22, ingresos: 1890 },
    { mes: 'Sep', ventas: 19, ingresos: 1720 },
    { mes: 'Oct', ventas: 25, ingresos: 2150 },
    { mes: 'Nov', ventas: 28, ingresos: 2380 },
    { mes: 'Dic', ventas: 24, ingresos: 2450 },
  ],

  distribucionVentas: [
    { tipo: 'SUV', valor: 45 },
    { tipo: 'Sedan', valor: 30 },
    { tipo: 'Pickup', valor: 18 },
    { tipo: 'Hatchback', valor: 7 },
  ],
};
...
export default function Dashboard() {
  ...
  const [data] = useState(isTestUser ? demoData : {
    vehiculosActivos: 0,
    pujasRecibidas: 0,
    vehiculosVendidos: 0,
    ingresosEstimados: 0,
  ...
  const statsCards = [
    ...
    { 
      icon: DollarSign, 
      value: formatCurrency(data.ingresosEstimados), 
      label: 'Ingresos', 
      color: 'bg-amber-600',
      change: `+${data.crecimientoMensual}%`,
      positive: true
    },
  ];
      ...
      <div className="bg-gradient-to-br from-violet-700 via-violet-600 to-violet-800 px-4 pt-6 pb-6">
        <div className="flex items-center justify-between mb-4">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => navigate(createPageUrl('Cuenta'))}
            ...
            <ResponsiveContainer width="100%" height={120}>
              <PieChart>
                <Pie
                  ...
                  dataKey="valor"
                >
                  {data.distribucionVentas.map((entry, index) => (
