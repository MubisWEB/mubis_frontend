  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      <div className="max-w-3xl mx-auto px-4 py-4 space-y-6">
        ...
        <h1 className="text-xl font-bold text-foreground font-sans leading-none">
          Movimientos
        </h1>
      </div>
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">
              Cuando realices transacciones, se mostrarán aquí.
            </p>
          </motion.div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                        isSale ? 'bg-primary/10' : 'bg-secondary/10'
                      }`}
                    >
                      {isSale ? (
                  ...
                  <div className="text-right shrink-0 ml-3">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${STATUS_COLORS[tx.status]}`}
                    >
                      {STATUS_LABELS[tx.status] || tx.status}
                    </span>
                  </div>
